...
- [x] PDF 생성 API 응답 크기 최적화 (폰트 서브셋) — NotoSansKR 서브셋 TTF 생성 (6019KB→2319KB, 61.5%↓) 완료
- [x] Core Web Vitals 측정 및 LCP/CLS 개선 — loading.tsx 레이아웃 불일치 수정으로 CLS 방지 완료
- [x] Vercel Edge Config 및 환경변수 보안 검토 — API 키 클라이언트 번들 미포함 확인, 조기 실패 가드 추가 완료
...
| Task 4.1 | 에러 처리 및 로딩 UI 개선 | ✅ 완료 |
| Task 4.2 | 성능 최적화 (ISR 캐싱, 폰트 서브셋, CLS, 보안 감사) | ✅ 완료 |
...
**PRD 참조**: docs/PRD.md
**작성일**: 2025-10-02
**최종 수정**: 2026-06-28 (Task 4.2 성능 최적화 전체 완료 — 폰트 서브셋 61.5%↓, CLS 개선, 환경변수 보안 감사)
